...
public class App extends Application {
    ...
    public static void main(String[] args) {
       ...
       String query_raw2_jeep = "FROM Vehiculo SET \"1\", \"Jeep\", \"Avenger\", 37500, 10000, \"Images/Jeep 1.jpeg\", \"El Jeep Avenger es un SUV eléctrico pequeño y elegante que ofrece una conducción divertida y un diseño atractivo. Tiene un motor de 156 CV y una batería de 50 kWh que le da una autonomía de hasta 392 km.\"";
       String query_raw2_tesla = "FROM Vehiculo SET \"2\", \"Tesla\", \"Model Y\", 43970, 15000, \"Images/tesla y 1.jpg\", \"El Tesla Model Y es un SUV eléctrico de tamaño mediano que ofrece un rendimiento impresionante y una gran autonomía. Tiene un motor de 351 CV y una batería de 75 kWh que le da una autonomía de hasta 507 km.\"";
       String query_raw2_toyota_hilux = "FROM Vehiculo SET \"3\", \"Toyota\", \"Hilux\", 34000, 12000, \"Images/Hilux1.jpg\", \"La Toyota Hilux es una camioneta pickup robusta y confiable que ofrece una gran capacidad de carga y un buen rendimiento todoterreno. Tiene un motor de 2.4 litros y 150 CV.\"";
       String query_raw2_ford_ranger = "FROM Vehiculo SET \"4\", \"Ford\", \"Ranger\", 32200, 20000, \"Images/ford-ranger 1.jpg\", \"La Ford Ranger es una camioneta pickup moderna y versátil que ofrece una conducción cómoda y una amplia gama de tecnologías. Tiene un motor de 2.0 litros y 180 CV.\"";
       String query_raw2_mitsubishi_l200 = "FROM Vehiculo SET \"5\", \"Mitsubishi\", \"L200\", 29900, 25000, \"Images/MItsubishi 1.jpg\", \"La Mitsubishi L200 es una camioneta pickup económica y duradera que ofrece una gran capacidad de remolque y un buen rendimiento todoterreno. Tiene un motor de 2.4 litros y 150 CV.\"";
       String query_raw2_nissan_navara = "FROM Vehiculo SET \"6\", \"Nissan\", \"Navara\", 31500, 8000, \"Images/nissan navarra 1.jpeg\", \"La Nissan Navara es una camioneta pickup tecnológica y cómoda que ofrece una conducción segura y una amplia gama de funciones. Tiene un motor de 2.3 litros y 190 CV.\"";
       String query_raw2_isuzu_dmax = "FROM Vehiculo SET \"7\", \"Isuzu\", \"D-Max\", 27500, 9500, \"Images/isuzu 1.jpeg\", \"La Isuzu D-Max es una camioneta pickup robusta y confiable que ofrece una gran capacidad de carga y un buen rendimiento todoterreno. Tiene un motor de 1.9 litros y 164 CV.\"";
